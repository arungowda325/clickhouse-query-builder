...
namespace Wolverine\ClickhouseBuilder\Integrations\Laravel;

use Wolverine\ClickhouseClient\Client;
use Wolverine\ClickhouseClient\Cluster;
use Wolverine\ClickhouseClient\Common\ServerOptions;
use Wolverine\ClickhouseClient\Interfaces\TransportInterface;
use Wolverine\ClickhouseClient\Query;
use Wolverine\ClickhouseClient\Server;
use Wolverine\ClickhouseClient\ServerProvider;
use Wolverine\ClickhouseClient\Transport\HttpTransport;
...
use Wolverine\ClickhouseBuilder\Query\Expression;
...
class Connection extends \Illuminate\Database\Connection
{
     ...
     *
     * @var \Wolverine\ClickhouseClient\Query\QueryStatistic
     */
     ...
     * @throws \Wolverine\ClickhouseClient\Exceptions\ServerProviderException
     */
     ...
     *
     * @throws \Wolverine\ClickhouseBuilder\Exceptions\BuilderException
     *
     * @return array|\Wolverine\ClickhouseClient\Query\QueryStatistic
     */
     ...
     *
     * @param array|\Wolverine\ClickhouseClient\Query\QueryStatistic $queryStatistic
     */
     ...
     * @param array $options
     *
     * @return \Wolverine\ClickhouseClient\Interfaces\TransportInterface
     */
     ...
     *
     * @return \Wolverine\ClickhouseBuilder\Integrations\Laravel\Builder
     */
    ...
    public function selectAsync(array $queries)
    {
        ...
        foreach ($results as $i => $result) {
            /* @var \Wolverine\ClickhouseClient\Query\Result $result */
            /* @var Query $query */
     ...
     *
     * @return \Wolverine\ClickhouseBuilder\Integrations\Laravel\Connection
     */
