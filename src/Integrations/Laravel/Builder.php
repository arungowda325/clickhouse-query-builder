...
class Builder extends BaseBuilder
{
     ...
     *
     * @var \Wolverine\ClickhouseBuilder\Integrations\Laravel\Connection
     */
     ...
     * Builder constructor.
     *
     * @param \Wolverine\ClickhouseBuilder\Integrations\Laravel\Connection $connection
     */
     ...
     *
     * @throws \Wolverine\ClickhouseClient\Exceptions\ClientException
     *
     * @return \Wolverine\Clickhouse\Query\Result|\Wolverine\Clickhouse\Query\Result[]
     */
    public function get()
    {
        if (!empty($this->async)) {
     ...
     *
     * @throws \Wolverine\Clickhouse\Exceptions\ClientException
     *
     * @return int|mixed
     */
     ...
     * @throws \Wolverine\Clickhouse\Exceptions\ClientException
     *
     * @return mixed|null|\Wolverine\Clickhouse\Query\Result
     */
     ...
     *
     * @param array                                                 $columns
     * @param string|\Wolverine\Clickhouse\Interfaces\FileInterface $file
     * @param string                                                $format
     *
     * @return bool
     */
     ...
     * @param bool  $skipSort
     *
     * @throws \Wolverine\ClickhouseBuilder\Exceptions\GrammarException
     *
     * @return bool
     */
